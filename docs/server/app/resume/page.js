...
const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 1148)), "/Users/nirmalpatel/next-portfolio/src/app/resume/page.tsx"],
    ...
    manifest: undefined
        ...
        {
        'layout': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 1946)), "/Users/nirmalpatel/next-portfolio/src/app/layout.tsx"],
...
const pages = ["/Users/nirmalpatel/next-portfolio/src/app/resume/page.tsx"];
...
__webpack_require__.d(__webpack_exports__, {
  WorkHistory: () => (/* binding */ WorkHistory)
});

// EXTERNAL MODULE: external "next/dist/compiled/react/jsx-runtime"
var jsx_runtime_ = __webpack_require__(6786);
;// CONCATENATED MODULE: ./src/constants/timeline.tsx
const timeline = [
    {
        company: "Illinois Institute of Technology",
        title: "Graduate Teaching Assistant",
        date: "August 2024 - Current",
        description: "Guiding students in next next generation transformer based models in NLP",
        responsibilities: [
            "Guiding and helping getting the industry exposure to students for Natural Language Processing course."
        ]
    },
    {
        ...
        description: "Built reusable and configurable video player",
        responsibilities: [
    ...
    },
    {
        ...
        description: "Explored correlation between tax and public health",
        responsibilities: [
    ...
    },
    {
        ...
        description: "Built next generation mortgage product",
        responsibilities: [
            "Contributed on Document Classification and Extraction project with Web Application tech stack - Java Spring boot and Python Django," + "MongoDB and Postgres DB, Angular UI, Azure Cloud.",
            "Achieved the performance boost of 40+% by using parallel and scalable architecture using suitable design patterns.",
            "Research experience on Generative AI models i.e., fine-tuning GPT 3.5 Models for domain specific use cases.",
            "Improved image pipeline performance with Rapids, rewarded Multiple “On the Spot Award” for work of Image Process Pipeline and multi-" + "fold improvement in extraction accuracy.",
            "Optimized search operations using Apache Solr and reducing DB load by 30-40% resulting great performance boost.",
            "Developed Jenkins CI/CD using Azure DevOps achieving 100% successful Deployment."
        ]
    }
];
...
;// CONCATENATED MODULE: ./src/components/WorkHistory.tsx
/* __next_internal_client_entry_do_not_use__ WorkHistory auto */ 
...
const WorkHistory = ()=>{
    return /*#__PURE__*/ jsx_runtime_.jsx("div", {
        children: timeline.map((item, index)=>/*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                        children: [
                            ...
                            /*#__PURE__*/ jsx_runtime_.jsx(Paragraph/* Paragraph */.n, {
                                className: "text-base md:text-base lg:text-base font-semibold",
                                children: item.title
                            }),
                            /*#__PURE__*/ jsx_runtime_.jsx(Paragraph/* Paragraph */.n, {
                                className: "text-sm md:text-sm lg:text-sm mb-4",
                                children: item.description
                            }),
                            item.responsibilities.map((responsibility, index)=>/*#__PURE__*/ jsx_runtime_.jsx(Step, {
...
const Step = ({ children })=>{
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
        className: "flex space-x-1 items-start my-2",
        children: [
            /*#__PURE__*/ jsx_runtime_.jsx(tabler_icons_react/* IconCircleCheckFilled */.rSH, {
...
const proxy = (0,module_proxy.createProxy)(String.raw`/Users/nirmalpatel/next-portfolio/src/components/WorkHistory.tsx`)
...
var __webpack_exports__ = __webpack_require__.X(0, [587,885,114], () => (__webpack_exec__(6137)));
